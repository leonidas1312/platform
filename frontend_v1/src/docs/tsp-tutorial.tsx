...
import { ArrowLeft, FileText, Code, ExternalLink, Download } from "lucide-react"
...
plt.show()`}</pre>
                  ...
                  <div className="bg-secondary/50 p-3 rounded-md font-mono text-sm mb-4">
                    <pre>{`# The TSP class automatically creates the QUBO formulation
qubo = tsp.qubo
...
plt.show()`}</pre>
                  ...
                  <div className="bg-secondary/50 p-3 rounded-md font-mono text-sm mb-4">
                    <pre>{`# For larger problems, we can use decomposition techniques
n_cities = 20
...
plt.show()`}</pre>
                  ...
                  <div className="bg-secondary/50 p-3 rounded-md font-mono text-sm mb-4">
                    <pre>{`# Create TSP with custom penalty coefficients
...
print(f"Custom penalties: Tour={tour_custom}, Length={length_custom:.4f}")`}</pre>
                  </div>
                </CardContent>
              </Card>
            </section>
...
print("Map saved to delivery_route.html")`}</pre>
                  </div>
                </CardContent>
              </Card>
            </section>
