...
import { ArrowLeft, FileText, Code, GitBranch, ExternalLink } from "lucide-react"
            ...
            <section>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <div className="bg-secondary/50 p-4 rounded-md text-center mb-4">
            ...
            <section>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <div className="bg-secondary/50 p-3 rounded-md font-mono text-sm mb-4">
                    <pre>{`import qubots as qb
...
qubo = qb.convert_to_qubo(problem, penalty_coefficient=5.0)`}</pre>
                  </div>
                </CardContent>
              </Card>
            </section>
...
# Visualize
maxcut.plot_solution(result.solution)`}</pre>
                      </div>
...
# Visualize
tsp.plot_solution(result.solution)`}</pre>
                      </div>
                      <Button variant="outline" size="sm" asChild>
...
print(f"Total weight: {sum(weights[selected])}")`}</pre>
                      </div>
                      <Button variant="outline" size="sm" asChild>
...
# Visualize
coloring.plot_solution(result.solution)`}</pre>
                      </div>
                      <Button variant="outline" size="sm" asChild>
...
print(f"Reduced variables: {reduced_qubo.num_variables}")`}</pre>
                  </div>
...
# Combine results
combined_result = qb.combine_results(subproblems, sub_results)`}</pre>
                  </div>
                </CardContent>
              </Card>
            </section>
